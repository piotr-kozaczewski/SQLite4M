...
{
    //printf("-----> KVWTMem::acquireWTResources(...)\n");
   ...
   )
{
   ...
   {
      printf("\nFailed KVWTMem::kVStoreOpen() : failed creation of the new KVWT.\n");
      return SQLITE4_ERROR;
   }
   ...
   if (ret != SQLITE4_OK)
   {
      printf("\nFailed KVWTMem::kVStoreOpen() : failed acquireWTResources(...)\n");
      return SQLITE4_ERROR;
   }
   //
