...
LIBOBJ+= vdbe.o parse.o \
         ...
         icu.o insert.o kv.o kvmem.o legacy.o \
...
sqlite4$(EXE):	$(TOP)/src/shell.c libsqlite4.a sqlite4.h
	$(TCCX) $(READLINE_FLAGS) -I/media/sf_BerkeleyDB/5.3.28p1/build_unix -o sqlite4$(EXE)                  \
		$(TOP)/src/shell.c                              \
		libsqlite4.a $(LIBREADLINE) $(TLIBS) $(THREADLIB) -L/media/sf_BerkeleyDB/5.3.28p1/build_unix -ldb

sqlite4.o:	sqlite4.c
	$(TCCX) -c sqlite4.c
    #$(TCCX) -I/media/sf_BerkeleyDB/5.3.28p1/build_unix -c sqlite4.c
