...
*/
sqlite4_kvfactory sqlite4GetKVStoreFactoryFunction(const char * sPluginName)
{
...
int sqlite4_load_kvstore_plugin(sqlite4_env * penv, const char * kvstore_plugin_name, const char * kvstore_alias)
{
