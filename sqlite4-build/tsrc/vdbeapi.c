...
*/
int sqlite4_txn_begin2(sqlite4 * db, int iLevel)
{
...
int sqlite4_txn_begin(sqlite4 * db) // iLevel == 2
{
...
*/
int sqlite4_txn_rollback2(sqlite4 * db, int iLevel)
{
...
int sqlite4_txn_rollback(sqlite4 * db) // iLevel == 0 or 1 ?
{
...
*/
int sqlite4_txn_commit_phase_one2(sqlite4 * db, int iLevel)
{
...
int sqlite4_txn_commit_phase_one(sqlite4 * db) // iLevel == 0 or 1 ?
{
...
*/
int sqlite4_txn_commit_phase_one_xid2(sqlite4 * db, int iLevel, void * xid)
{
...
int sqlite4_txn_commit_phase_one_xid(sqlite4 * db, void * xid) // iLevel == 0 or 1 ?
{
...
*/
int sqlite4_txn_commit_phase_two2(sqlite4 * db, int iLevel)
{
...
int sqlite4_txn_commit_phase_two(sqlite4 * db) // iLevel == 0 or 1 ?
{
...
*/
int sqlite4_txn_commit2(sqlite4 * db, int iLevel)
{
...
int sqlite4_txn_commit(sqlite4 * db) // iLevel == 0 or 1 ?
{
