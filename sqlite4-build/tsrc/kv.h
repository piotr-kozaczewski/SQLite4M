...
int sqlite4KVStoreOpenBdb(sqlite4_env*, KVStore**, const char *, unsigned);
int sqlite4KVStoreOpenBdbMem(sqlite4_env*, KVStore**, const char *, unsigned);
...
int sqlite4KVStoreCommitPhaseOneXID(KVStore *p, int iLevel, void * xid);
