...
*/
int sqlite4VdbeBegin(sqlite4 *db, int iLevel) {
...
int sqlite4VdbeCommitPhaseOne(sqlite4 *db, int iLevel){
...
int sqlite4VdbeCommitPhaseOneXID(sqlite4 *db, int iLevel, void * xid){
...
int sqlite4VdbeCommitPhaseTwo(sqlite4 *db, int iLevel){
